...
export const menuData: Menu[] = [
  {
    ...
    thumbnail: 'https://drive.google.com/file/d/1icBke6q1iMpaDYB6tunYdImQmcAfTMHo/view?usp=drive_link',
    serviceList: 'Perfect for Buffets,\nSpecial Occasions,\nParties, and\nHouse Warmings',
    images: [
      { src: 'https://drive.google.com/file/d/1icBke6q1iMpaDYB6tunYdImQmcAfTMHo/view?usp=drive_link', alt: 'Breakfast buffet' },
      { src: 'https://drive.google.com/file/d/1csoVWcn4ei5tgNQJgtB3tHlc5txw6Xqd/view?usp=drive_link', alt: 'Breakfast muffins' },
      { src: 'https://drive.google.com/file/d/1KU0RTBahcf3Jr87wVZ6ezvyeE6xjggJT/view?usp=drive_link', alt: 'Fruit platter' },
    ],
    categories: [
      {
        name: 'Platters',
  ...
  },
  {
    ...
    thumbnail: 'https://drive.google.com/file/d/12zOC6k7PvePR-plJdVvozn_tBfo52kBf/view?usp=drive_link',
    serviceList: 'Residential or Corporate\nDiverse Menus\nAll You Can Eat!\nSummer Specials',
    images: [
      { src: 'https://drive.google.com/file/d/12zOC6k7PvePR-plJdVvozn_tBfo52kBf/view?usp=drive_link', alt: 'Lunch sandwiches' },
      { src: 'https://drive.google.com/file/d/17DT6UCk42JVTXX7deg2mXKcOjKb17e8P/view?usp=drive_link', alt: 'Gourmet salad' },
      { src: 'https://drive.google.com/file/d/1aQstJbCu4dqohgSiXVme_1IHWcft1-2D/view?usp=drive_link', alt: 'Boxed lunches' },
    ],
    categories: [
      {
        name: 'Sandwich Boxes',
  ...
  },
  {
    ...
    thumbnail: 'https://drive.google.com/file/d/1vAwsd8GkhXIxuFrJZo_3dayas2rmWt0r/view?usp=drive_link',
    serviceList: 'Buffets\nSpecial Occasions\nParties\nHouse Warmings',
     images: [
      { src: 'https://drive.google.com/file/d/1vAwsd8GkhXIxuFrJZo_3dayas2rmWt0r/view?usp=drive_link', alt: 'Hot buffet spread' },
      { src: 'https://drive.google.com/file/d/1p6oB1SQHgxUwB3fgYy9crxNLtxZz4gWX/view?usp=drive_link', alt: 'Catering dishes' },
      { src: 'https://drive.google.com/file/d/16cA2P-GN9YXr1MnUqRXX2rpxBM2UcT26/view?usp=drive_link', alt: 'Party catering' },
    ],
    categories: [
      {
        name: 'Entrees',
  ...
  },
  {
    ...
    thumbnail: 'https://drive.google.com/file/d/1JK5yMGn9LI6eeWd94rTz9fRNygAJGymo/view?usp=drive_link',
    images: [
      { src: 'https://drive.google.com/file/d/1JK5yMGn9LI6eeWd94rTz9fRNygAJGymo/view?usp=drive_link', alt: 'Grilled picnic food' },
      { src: 'https://drive.google.com/file/d/1l_KvESBU7n_W8S9MrcYFBKq8loGtwXqv/view?usp=drive_link', alt: 'BBQ meats' },
    ],
    categories: [
      {
  ...
  },
  {
    ...
    thumbnail: 'https://drive.google.com/file/d/1FHOgV9sZylLOcfqJfXciqOW5iwx9MAuV/view?usp=drive_link',
     images: [
      { src: 'https://drive.google.com/file/d/1FHOgV9sZylLOcfqJfXciqOW5iwx9MAuV/view?usp=drive_link', alt: 'Chocolate truffles' },
      { src: 'https://drive.google.com/file/d/1Q_VrrW0humF-lMJv1W6xgljZvQpr_lQC/view?usp=drive_link', alt: 'Assorted pastries' },
    ],
    categories: [
      {
